 ...
 * @method Servicio  setCategoriaId()        Sets the current record's "categoria_id" value
 * @method Servicio  setCicloId()            Sets the current record's "ciclo_id" value
 * @method Servicio  setGradoId()            Sets the current record's "grado_id" value
 * @method Servicio  setGrupoId()            Sets the current record's "grupo_id" value
 * 
 * @package    puntoveta
 * @subpackage model
