...
/**
 * ServicioCliente form base class.
 *
 * @method ServicioCliente getObject() Returns the current form's model object
 *
 * @package    puntoveta
 * @subpackage form
 ...
 */
abstract class BaseServicioClienteForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('servicio_cliente[%s]');
