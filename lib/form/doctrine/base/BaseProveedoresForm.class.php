...
/**
 * Proveedores form base class.
 *
 * @method Proveedores getObject() Returns the current form's model object
 *
 * @package    puntoveta
 * @subpackage form
 ...
 */
abstract class BaseProveedoresForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('proveedores[%s]');
