...
// date: 2016/07/06 07:14:42
$response = $this->context->getResponse();

if ($this->actionName.$this->viewName == 'pagarServicioSuccess')
{
...
if ($templateName.$this->viewName == 'pagarServicioSuccess')
{
  ...
  $response->addJavascript('pagarServicio.js', '', array ());
}
else
{
  if (null !== $layout = sfConfig::get('symfony.view.'.$this->moduleName.'_'.$this->actionName.'_layout'))
