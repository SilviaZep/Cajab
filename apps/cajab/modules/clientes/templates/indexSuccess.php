...
<div  class="panel-body">
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ClientesModal">  
        <i class="fa fa-user-plus"> Nuevo Cliente</i>
    </button>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer" id="guardarCliente">                       
                ...
                <a id="btn-cliente" href="#" class="btn btn-success" role="button">Guardar</a>                        
            </div>             
        </div>
    </div>
</div>
...
<div class="modal fade" id="ClientesModificarModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel1">Actualizar Cliente</h4>
            </div>
            <div class="modal-body">
                <div class="row">
            ...
            <div class="modal-footer" id="modificarCliente">                       
                <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button> 
                <a id="btn-clienteModificar" href="#" class="btn btn-success" role="button">Actualizar</a>                        
            </div> 
        </div>
    </div>
</div>
<div>
    ...
    <table id = "clientesTable" class = "display" cellspacing = "0" width = "100%">
        <thead>
            <tr>
...
<script>
    ...
    $(document).ready(function(){
     $("#mClientes").addClass("activeNew");
        ...
        var clienteTable = $("#clientesTable").dataTable({
            sDom: 't<"bottom"p>',
            "pageLength": 8,
            "aoColumns": [ 
                { "sClass": "" },
        ...
        $("#clientesSearch").keyup(function(){
            clienteTable.api().search($(this).val()).draw();
        });
    ...
    $("#btn-cliente").click(function(){
		...
		{
        $.ajax({          
            url: "<?php echo url_for("@agregar_clientes"); ?>",
            data:dataForm,
            type: 'POST',       
            contentType: false,
            dataType: "JSON",
	 ...
	 $("#btn-clienteModificar").click(function(){
        dataForm = new FormData();       
        ...
        $.ajax({          
            url: "<?php echo url_for("@clientes_modificar"); ?>",
            data:dataForm,
            type: 'POST',       
            contentType: false,
            dataType: "JSON",
